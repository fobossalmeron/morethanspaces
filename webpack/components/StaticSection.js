  ...
  render (){
    ...
    return (
      ...
      <section id="about">
        ...
        <p><b>best price, best quality</b></p>
        <p>In most cases we offer the <b>best rates</b>. In fact, we will try to match or beat any price <b>up to 20%</b>.<br/>
        We proudly work with companies, event planners and agencies across the USA and international.</p>
        </div>
        ...
        <p><b>Our motto:</b><br/>
            <b>more for less:</b> better service, better products, better results, less stress, less worry</p>
